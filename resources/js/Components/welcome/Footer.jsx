            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="hidden">
                  <h3 className="text-2xl font-black tracking-tight">Finanzas E Impuestos</h3>
        ...
        <div className="container mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="text-gray-400 text-sm text-center md:text-left">
              <p>Copyright © <span className="font-bold text-white">Finanzas E Impuestos Bolivia</span> {new Date().getFullYear()} – Todos los derechos reservados</p>
