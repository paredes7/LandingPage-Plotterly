...
className="group w-full max-w-[420px] flex flex-col items-center p-10 
                 bg-gradient-to-br from-blue-950/50 to-blue-900/90 
                 backdrop-blur-xl border border-white/10 rounded-[1rem] 
                 shadow-2xl min-h-[350px] cursor-pointer"    >
